...
const conString = 'postgres://postgres:GreyMyth540**@LOCALHOST:5432/lab09sql'; // Needs to point to the database!!!
...
app.get('/articles', (request, response) => {
  ...
  `)  // Needs to query multiple tables now!!!
    .then(result => {
      console.log('Joined articles & authors'); // REMOVE
...
app.post('/articles', (request, response) => { // In order to post, there is a three step query process to the database
  client.query( // Here's 1!!!
    `
...
app.put('/articles/:id', function(request, response) {  // :id is a wildcard reference
  client.query(
    `
